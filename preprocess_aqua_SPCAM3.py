...
import pdb
print(' ')
print('Lines Commented Out: 83')
print(' ')
print('Lines Added: 84')
print(' ')
...
def main(inargs):
    ...
    print('inargs')             #Line Added by Griffin Mooers
    print(inargs)               #Line Added by Griffin Mooers
    print(' ')                  #Line Added by Griffin Mooers
    ...
    if len(inargs.in_dir) == 1:
        print('inargs.in_dir[0] + inargs.aqua_names[0]')   #Line Added by Griffin Mooers
        print(inargs.in_dir[0] + inargs.aqua_names[0])     #Line Added by Griffin Mooers
        print(' ')                                          #Line Added by Griffin Mooers
