...
DATADIR = 'Preprocessed_Data/Summer_Months/'
...
callbacks = [keras.callbacks.TensorBoard(log_dir='my_log_dir/Exponential', histogram_freq=0), earlyStopping, mcp_save]
...
plot_model(model, to_file='my_log_dir/Exponential/model.png')
plot_model(model, show_shapes=True, to_file='my_log_dir/Exponential/models.png')



#Save the model
model.save('Models/Summer_Exponential.h5')  # creates a HDF5 file 'my_model.h5'
...
#plt.yscale('log')
plt.legend()
plt.savefig('Figures/Summer_Exponential.png')