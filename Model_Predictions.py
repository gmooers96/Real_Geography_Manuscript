...
DATADIR = '/fast/gmooers/Preprocessed_Data/9_Years_Spaced/'
...
model = keras.models.load_model('Models/9_years.h5')

path_to_file = 'Preprocessed_Data/9_Years_Spaced/full_physics_essentials_valid_month02_features.nc'
